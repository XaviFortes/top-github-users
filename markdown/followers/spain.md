...
The `number of followers` of users in Spain on `2025/10/22 4:25 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
