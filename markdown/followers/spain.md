...
The `number of followers` of users in Spain on `2025/9/12 4:20 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
