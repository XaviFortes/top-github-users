...
The `number of followers` of users in Spain on `2025/12/28 1:09 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
