...
The `public contributions` and `private contributions` by users in Spain on `2026/2/12 9:35 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
