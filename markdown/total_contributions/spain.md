...
The `public contributions` and `private contributions` by users in Spain on `2025/6/29 1:05 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
