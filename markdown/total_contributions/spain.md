...
The `public contributions` and `private contributions` by users in Spain on `2025/12/18 8:23 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
