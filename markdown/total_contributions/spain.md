...
The `public contributions` and `private contributions` by users in Spain on `2025/10/24 4:23 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
