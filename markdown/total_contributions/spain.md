...
The `public contributions` and `private contributions` by users in Spain on `2026/1/16 7:27 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
