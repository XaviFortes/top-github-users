...
The `public contributions` and `private contributions` by users in Spain on `2025/6/12 8:24 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
